...
import { createYTMusicApiClient, type YTMusicApiClient } from "./api-client.js";
  ...
  return {
      ...
      const albums: readonly CanonicalAlbum[] =
        albumResults.status === "fulfilled"
          ? albumResults.value.map((album) => ({
              ...
              tracks: [],
              sourceIds: [{ source: "ytmusic" as const, id: album.id }],
    ...
    async getAlbumTracks(albumId: string) {
      ...
      const album: CanonicalAlbum = {
        ...
        tracks,
        sourceIds: [{ source: "ytmusic" as const, id: albumDetails.id }],
        ...(albumDetails.year != null ? { year: albumDetails.year } : {}),
