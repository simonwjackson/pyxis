...
describe("extractVideoId", () => {
  it("extracts from youtube.com/watch URL", () => {
    expect(extractVideoId("https://www.youtube.com/watch?v=6uJ0eRFQszo")).toBe(
      "6uJ0eRFQszo",
    );
  });
  ...
  it("extracts from youtube.com/watch with extra params", () => {
    expect(
      extractVideoId("https://www.youtube.com/watch?v=6uJ0eRFQszo&t=120"),
    ).toBe("6uJ0eRFQszo");
  });

  it("extracts from youtu.be short URL", () => {
    expect(extractVideoId("https://youtu.be/6uJ0eRFQszo")).toBe("6uJ0eRFQszo");
  });

  it("extracts from youtube.com/embed URL", () => {
    expect(extractVideoId("https://www.youtube.com/embed/6uJ0eRFQszo")).toBe(
      "6uJ0eRFQszo",
    );
  });
  ...
  it("extracts from URL without protocol prefix in query", () => {
    expect(extractVideoId("youtube.com/watch?v=6uJ0eRFQszo")).toBe(
      "6uJ0eRFQszo",
    );
  });
});
