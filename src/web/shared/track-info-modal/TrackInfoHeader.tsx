	...
	return (
		<div className="flex gap-4">
			...
			<div className="min-w-0">
				<p className="font-semibold text-[var(--color-text)] truncate">{songName}</p>
				<p className="text-sm text-[var(--color-text-muted)] truncate">{artistName}</p>
				<p className="text-sm text-[var(--color-text-dim)] truncate">{albumName}</p>
				{duration > 0 ? (
