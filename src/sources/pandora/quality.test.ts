  ...
  describe("getAudioUrl", () => {
    ...
    describe("high quality", () => {
      it("should return additionalAudioUrl when string", () => {
        ...
        expect(getAudioUrl(item, "high")).toBe(
          "https://audio.pandora.com/high.mp3",
        );
      });
      ...
      it("should return first element when additionalAudioUrl is array", () => {
        const item: PlaylistItem = {
          ...baseItem,
          additionalAudioUrl: [
            "https://audio.pandora.com/first.mp3",
            "https://audio.pandora.com/second.mp3",
          ],
        };
        expect(getAudioUrl(item, "high")).toBe(
          "https://audio.pandora.com/first.mp3",
      ...
      it("should fallback to audioUrlMap.highQuality when no additionalAudioUrl", () => {
        const item: PlaylistItem = {
          ...
          audioUrlMap: {
            highQuality: {
              audioUrl: "https://audio.pandora.com/fallback.aac",
              bitrate: "64",
              encoding: "aacplus",
            },
            mediumQuality: {
              audioUrl: "https://audio.pandora.com/medium.aac",
              bitrate: "64",
              encoding: "aacplus",
            },
            lowQuality: {
              audioUrl: "https://audio.pandora.com/low.aac",
              bitrate: "32",
              encoding: "aacplus",
            },
          },
        ...
        expect(getAudioUrl(item, "high")).toBe(
          "https://audio.pandora.com/fallback.aac",
        );
      });
    ...
    describe("medium quality", () => {
      it("should return audioUrlMap.highQuality (64kbps AAC+)", () => {
        const item: PlaylistItem = {
          ...
          audioUrlMap: {
            highQuality: {
              audioUrl: "https://audio.pandora.com/high.aac",
              bitrate: "64",
              encoding: "aacplus",
            },
            mediumQuality: {
        ...
        expect(getAudioUrl(item, "medium")).toBe(
          "https://audio.pandora.com/high.aac",
        );
      });
    ...
    describe("low quality", () => {
      it("should return audioUrlMap.lowQuality (32kbps AAC+)", () => {
        ...
        expect(getAudioUrl(item, "low")).toBe(
          "https://audio.pandora.com/low.aac",
        );
      });
