...
const cutoverEndpointInventory: readonly CutoverEndpoint[] = [
  endpoint(
    ...
    [
      "src/web/features/settings/SettingsPage.tsx",
      "src/web/shared/layout/Sidebar.tsx",
      "src/web/shared/layout/MobileNav.tsx",
    ],
  ...
  endpoint(
    ...
    "Pandora protected-procedure errors",
    ["src/web/shared/TrackInfoModal/TrackInfoTraits.tsx"],
  ...
  endpoint(
    ...
    [
      ...
      "src/web/features/genres/GenresPage.tsx",
  ...
  endpoint(
    ...
    ["src/web/shared/playback/usePlayback.ts playerStateStreamAtom"],
  ...
  endpoint(
    ...
    ["src/web/features/history/HistoryPage.tsx"],
