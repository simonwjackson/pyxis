...
describe("computeSimilarity", () => {
  test("identical releases have similarity 1", () => {
    const a = makeRelease({
      title: "Abbey Road",
      artists: [{ name: "The Beatles", ids: [{ source: "pandora", id: "1" }] }],
      year: 1969,
    });
    const b = makeRelease({
      title: "Abbey Road",
  ...
  test("completely different releases have low similarity", () => {
    ...
    const b = makeRelease({
      title: "Nevermind",
      artists: [{ name: "Nirvana", ids: [{ source: "pandora", id: "2" }] }],
    });
    const sim = computeSimilarity(a, b);
  ...
  test("year match adds bonus", () => {
    ...
    const b = makeRelease({
      ...
      artists: [{ name: "Pink Floyd", ids: [{ source: "pandora", id: "2" }] }],
      year: 1973,
    });
    ...
    const d = makeRelease({
      title: "The Dark Side of Moon",
      artists: [{ name: "Pink Floyd", ids: [{ source: "pandora", id: "4" }] }],
      year: 2003,
    });
...
describe("createMatcher", () => {
  ...
  test("merges IDs without duplicates", () => {
    ...
    const release1 = makeRelease({
      title: "Test Album",
      artists: [{ name: "Artist", ids: [{ source: "pandora", id: "p1" }] }],
      year: 2020,
      ids: [{ source: "pandora", id: "p1" }],
    });
    const release2 = makeRelease({
  ...
  test("prefers Discogs artwork", () => {
    ...
    const release2 = makeRelease({
      title: "Test Album",
      artists: [{ name: "Artist", ids: [{ source: "discogs", id: "d1" }] }],
      year: 2020,
      ids: [{ source: "discogs", id: "d1" }],
