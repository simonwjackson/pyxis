...
describe("createSourceManager", () => {
  ...
  describe("getPlaylistTracks", () => {
    ...
    it("throws error for unknown source", async () => {
      ...
      await expect(
        manager.getPlaylistTracks("ytmusic", "playlist-id"),
      ).rejects.toThrow('Source "ytmusic" does not support playlists');
    });
    ...
    it("throws error for source without playlist capability", async () => {
      ...
      await expect(
        manager.getPlaylistTracks("musicbrainz", "playlist-id"),
      ).rejects.toThrow('Source "musicbrainz" does not support playlists');
    });
  });
  ...
  describe("getStreamUrl", () => {
    ...
    it("throws error for source without stream capability", async () => {
      ...
      await expect(
        manager.getStreamUrl("musicbrainz", "track-id"),
      ).rejects.toThrow('Source "musicbrainz" does not support streaming');
    });
  });
  ...
  describe("getAlbumTracks", () => {
    ...
    it("throws error for unknown source", async () => {
      ...
      await expect(
        manager.getAlbumTracks("ytmusic", "album-id"),
      ).rejects.toThrow('Source "ytmusic" does not support album tracks');
    });
    ...
    it("throws error for source without album capability", async () => {
      ...
      await expect(
        manager.getAlbumTracks("pandora", "album-id"),
      ).rejects.toThrow('Source "pandora" does not support album tracks');
    });
  });
