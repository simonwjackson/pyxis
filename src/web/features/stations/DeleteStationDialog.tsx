    ...
    >
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          <div
            className="w-10 h-10 bg-pyxis-highlight flex items-center justify-center"
            aria-hidden="true"
          >
            <Trash2 className="w-5 h-5 text-pyxis-error" />
          </div>
          <h2
        ...
        <p className="text-sm text-pyxis-muted mb-1">
          are you sure you want to delete
        </p>
        <p className="text-sm font-medium text-pyxis-text mb-4">
          &ldquo;{stationName}&rdquo;?
        </p>
        <p id="delete-dialog-desc" className="text-xs text-pyxis-dim mb-6">
        ...
        <div className="flex gap-3 justify-end">
          ...
          <button
            ...
            disabled={isDeleting}
            className="px-4 py-2 text-sm text-white bg-pyxis-error hover:brightness-110 transition-colors disabled:opacity-50"
          >
